...
<head>
    ...
    <link href="{{asset('assets_files/css/media_query.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('assets_files/css/bootstrap.css')}}" rel="stylesheet" type="text/css"/>
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"
          integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <link href="{{asset('assets_files/css/animate.css')}}" rel="stylesheet" type="text/css"/>
    <link href="https://fonts.googleapis.com/css?family=Poppins" rel="stylesheet">
    <link href="{{asset('assets_files/css/owl.carousel.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('assets_files/css/owl.theme.default.css')}}" rel="stylesheet" type="text/css"/>
    <!-- Bootstrap CSS -->
    <link href="{{asset('assets_files/sass/style_1.css')}}" rel="stylesheet" type="text/css"/>
    <!-- Modernizr JS -->
    <script src="{{asset('assets_files/js/modernizr-3.5.0.min.js')}}"></script>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 fh5co_mediya_center">
                ...
                <script>window.myWidgetParam ? window.myWidgetParam : window.myWidgetParam = [];  window.myWidgetParam.push({id: 18,cityid: '1283711',appid: '88e5a40360664bc741e6fe85aaa1e991',units: 'metric',containerid: 'openweathermap-widget-18',  });  (function() {var script = document.createElement('script');script.async = true;script.charset = "utf-8";script.src = "//openweathermap.org/themes/openweathermap/assets/vendor/owm/js/weather-widget-generator.js";var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(script, s);  })();</script>
...
<div class="container-fluid pt-3">
    <div class="container animate-box" data-animate-effect="fadeIn">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4"> {{$firstHeading[0]->categoryName}}</div>
        </div>
        ...
        <div class="owl-carousel owl-theme js" id="slider1">
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="{{$mainnews->feature}}" alt="{{$mainnews->newsTitle}}"
                                                               class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="{{route('news.newsDetail', ['id'=>$mainnews->id])}}" class="text-white"> {{$mainnews->newsTitle}}</a>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">{{$prabashHeading[0]->categoryName}}</div>
                </div>
                @foreach($prabashMainNews as $prabashnews)
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{$prabashnews->feature}}" alt="{{$prabashnews->newsTitle}}"/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="{{route('news.newsDetail', ['id'=>$prabashnews->id])}}"  class="fh5co_magna py-2">{{$prabashnews->newsTitle}} </a>
                        <div class="fh5co_consectetur"> {{ str_limit(strip_tags($prabashnews->newsDesc),$limit = 300, $end = '...') }}
                        </div>
                    </div>
                </div>
                    <hr>
            ...
            <div class="col-md-4 animate-box" data-animate-effect="fadeInRight">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4"> <i class="fa fa-calendar" aria-hidden="true"></i> इभेन्ट्स</div>
                </div>
                <div class="clearfix"></div>
                        ...
                        <ul class="event-list">
                            <li>
                                <time datetime="2014-07-20">
                                    <span class="day">{{Carbon\Carbon::parse($event->eventDate)->format('d')}}</span>
                                    <span class="month">{{Carbon\Carbon::parse($event->eventDate)->format('M')}}</span>
                                    <span class="year">{{Carbon\Carbon::parse($event->eventDate)->format('Y')}}</span>

                                </time>
                                <div class="info">
                                    <h2 class="title" style="color:#103561">
                                    ...
                                    <p class="desc">{{$event->eventLocation}}</p>
                                </div>
                            </li>
                        </ul>
                    @endforeach
                ...
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom pt-3 py-2 mb-4"> विचार</div>
                </div>
                @foreach($articles as $article)
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <a href="{{route('article.newsDetail', ['id'=>$article->id])}}">
                         <img src="{{$article->articlePhoto}}" alt="{{$article->articleTitle}}" class="fh5co_most_trading"/>
                        </a>
                    </div>
...
<div class="container-fluid pt-1">
    <div class="container animate-box" data-animate-effect="fadeIn">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4"> {{$vdcHeading[0]->categoryName}}</div>
        </div>
        ...
        <div class="owl-carousel owl-theme" id="slider2">
            @foreach($vdcMainNews as $vdcnews)
                <div class="item px-2">
                    <div class="fh5co_latest_trading_img_position_relative">
                        <div class="fh5co_latest_trading_img"><img src="{{$vdcnews->feature}}" alt="{{$vdcnews->newsTitle}}"
                                                                   class="fh5co_img_special_relative"/></div>
                        <div class="fh5co_latest_trading_img_position_absolute_1">
                            <a href="{{route('news.newsDetail', ['id'=>$vdcnews->id])}}" class="text-white"> {{$vdcnews->newsTitle}}</a>
                        </div>
                    </div>
                </div>
            @endforeach
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">hjdshj</div>
        </div>
        <div class="owl-carousel owl-theme" id="slider2">
            {{--@foreach($vdcMainNews as $vdcnews)--}}
            {{--<div class="item px-2">--}}
                {{--<div class="fh5co_hover_news_img">--}}
                    {{--<div class="fh5co_news_img"><img src="{{$vdcnews->feature}}" alt="{{$vdcnews->newsTitle}}"/></div>--}}
                    {{--<div>--}}
                        {{--<a href="{{route('news.newsDetail', ['id'=>$vdcnews->id])}}" class="d-block fh5co_small_post_heading"><span class="">{{$vdcnews->newsTitle}}</span></a>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
            {{--@endforeach--}}
    ...
    <div class="container animate-box">
        <div class="row">
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <div class="footer_makes_sub_font"> Dec 31, 2016</div>
                <a href="#" class="footer_post pb-4"> Success is not a good teacher failure makes you humble </a>
                <div class="footer_position_absolute"><img src="assets_files/images/footer_sub_tipik.png" alt="img" class="width_footer_sub_img"/></div>
            </div>
...
<script src="{{asset('assets_files/js/openWeather.js')}}"></script>
<script src="{{asset('assets_files/js/owl.carousel.min.js')}}"></script>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<!-- Waypoints -->
<script src="{{asset('assets_files/js/jquery.waypoints.min.js')}}"></script>
<!-- Main -->
<script src="{{asset('assets_files/js/main.js')}}"></script>
